                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Login Tirta Musi
                                            Internship </p>
                                        ...
                                        <div>
                                            <p class="text-gray-600" align="center">Don't have an account? <a
                                                    href="{{ route('register') }}" class="font-bold">Sign
                                                    up</a>.</p>
                                            <center>
                                                <p><a class="font-bold" href="auth-forgot-password.html">Forgot
                                                        password?</a></p>
                                            </center>
                                        </div>
