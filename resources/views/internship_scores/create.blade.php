                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="apprentince_id" class="form-control mb-3 select_apprentince" required>
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number" min="1" max="10" step="0.1" class="form-control"
                                                placeholder="Masukkan Nilai Disiplin" value="{{ old('discipline_score') }}"
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                placeholder="Masukkan Nilai Kerjasama" value="{{ old('teamwork_score') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                placeholder="Masukkan Nilai Inisiatif" value="{{ old('initiative_score') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                placeholder="Masukkan Nilai Kerajinan" value="{{ old('diligent_score') }}"
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                ...
                                                value="{{ old('responsibility_score') }}" id="responsibility_score"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                placeholder="Masukkan Nilai Sikap" value="{{ old('attitude_score') }}"
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="number"  min="1" max="10" step="0.01" class="form-control"
                                                ...
                                                value="{{ old('performance_score') }}" id="performance_score"
