                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"
                                                placeholder="Masukkan Nilai Disiplin" value="{{ old('discipline_score') }}" id="discipline_score" name="discipline_score" required>
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"  placeholder="Masukkan Nilai Kerjasama" value="{{ old('teamwork_score') }}" id="teamwork_score" name="teamwork_score" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"
                                                placeholder="Masukkan Nilai Inisiatif" value="{{ old('initiative_score') }}" id="initiative_score" name="initiative_score" required>
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"  placeholder="Masukkan Nilai Kerajinan" value="{{ old('diligent_score') }}" id="diligent_score" name="diligent_score" required>
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"  placeholder="Masukkan Nilai Tanggung Jawab" value="{{ old('responsibility_score') }}" id="responsibility_score" name="responsibility_score" required>
                                ...
                                <div class="col-lg-6" >
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"  placeholder="Masukkan Nilai Sikap" value="{{ old('attitude_score') }}" id="attitude_score" name="attitude_score" required>
                                ...
                                <div class="col-lg-12" >
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control"  placeholder="Masukkan Nilai Prestasi" value="{{ old('performance_score') }}" id="performance_score" name="performance_score" required>
