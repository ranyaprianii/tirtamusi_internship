                    ...
                    <div class="card card-block p-card">
                        <div class="profile-box">
                            <div class="profile-card rounded">
                                <img src="{{ asset('mazer-admin/assets/images/tirtamusi.png') }}" alt="{{ $user['name'] }}"
                                    class="avatar-100 rounded d-block mx-auto img-fluid mb-3">
                                <h3 class="font-600  text-center mb-4">{{ $user['name'] }}</h3>
                            </div>
                            <div class="pro-content rounded">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <p class="mb-0 eml">Roles :
                                        @if (!empty($user->getRoleNames()))
                                            @foreach ($user->getRoleNames() as $item)
                                                <span class="badge bg-info ml-2">{{ $item }}</span>
                                            @endforeach
                                        @endif
                                    </p>
                                </div>
