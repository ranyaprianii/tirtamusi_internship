    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Lihat Unit</h4>
            </div>
        </div>
                    ...
                    <div class="card card-block p-card">
                        <div class="profile-box">
                            {{-- <div class="profile-card rounded">
                                <img src="{{ asset('mazer-admin/assets/images/tirtamusi.png') }}" alt="{{ $unit['name'] }}"
                                    class="avatar-100 rounded d-block mx-auto img-fluid mb-3">
                                <h3 class="font-600  text-center mb-4">{{ $unit['name'] }}</h3>
                            </div> --}}
                            <div class="pro-content rounded">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <p class="mb-0 eml">{{ $unit['description'] }}</p>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="p-icon mr-3">
