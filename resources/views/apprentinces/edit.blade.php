    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('apprentince.update', Crypt::encrypt($data['id'])) }}" method="post"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap"
                                        value="{{ old('name', $data['name']) }}" id="name" name="name" required>
                                    @error('name')
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" placeholder="Nisn / Nim"
                                        value="{{ old('nisn_nim', $data['nisn_nim']) }}" id="nisn_nim" name="nisn_nim"
                                        required>
                                    @error('nisn_nim')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" placeholder="Jurusan"
                                        value="{{ old('department', $data['department']) }}" id="department"
                        ...
                        <div class="col-12">
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <textarea type="text" class="form-control" placeholder="Alamat Lengkap" id="address" name="address" required>{{ old('address', $data['address']) }}</textarea>
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <div class="form-control-icon">
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" placeholder="Tempat Lahir"
                                        value="{{ old('birth_place', $data['birth_place']) }}" id="birth_place"
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="date" class="form-control" placeholder="Tanggal Lahir"
                                        value="{{ old('birth_date', $data['birth_date']) }}" id="birth_date"
