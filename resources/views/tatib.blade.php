    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#daftar">Panduan Pendaftaran dan Pengajuan
                            Magang</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class=col-md-6 col-12">
                                <h4 class="mb-4" data-aos="fade-up" data-aos-delay="600">Kantor Pusat Pelayanan Perumda
                                    Tirta Musi Palembang</h4>

                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i>Jl.
                                    Rambutan Ujung No.1, 30 Ilir, Kec. Ilir Barat II, Kota Palembang, Sumatera Selatan 30129
                                </p>
                                ...
                                <br>
                                <img src="{{ asset('landing_page/images/team/tirta1.jpg') }}" alt="Tirta Musi"
                                    width="450px" data-aos="fade-up" data-aos-delay="200">
                                <br> <br>
                                <img src="{{ asset('landing_page/images/tirta3.jpg') }}" alt="Tirta Musi" width="450px"
                                    data-aos="fade-up" data-aos-delay="200">
                            </div>

                            <div class="col-md-6 col-12">
                                <h4 class="mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">9 Kantor Cabang Unit
                                    Pelayanan Perumda Tirta Musi Palembang</h4>

                                <h5><b>Unit Pelayanan Rambutan</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/SyUN7q4m9iEJrfUz9">Jl. Rambutan Ujung No.01, Kel. 32 Ilir
                                        Kec. Ilir Barat II</a></p>

                                <br>
                                <h5><b>Unit Pelayanan KM. IV</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/Vqz2Eu3sWk8oyFxn7">Jl. Jendral Sudirman Kel. 20 Ilir Kec.
                                        Ilir Timur I</a></p>

                                <br>
                                <h5><b>Unit Pelayanan 3 Ilir</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/hfMenAVe8RsVUhGw6">Jl. Yos Sudarso Komp. Penyaringan No.
                                        01 Kel. 3 Ilir Kec. Ilir Timur II</a></p>

                                <br>
                                <h5><b>Unit Pelayanan Sako Kenten</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/hBTbCzmdJ6oURaGC7">Jl. Musi Raya Simpang Lekipali No. 186
                                        Kel. Suka Maju Kec. Sako</a></p>

                                <br>
                                <h5><b>Unit Pelayanan Seberang Ulu II</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/YWRsWAU3V6JkkEkd9">Jl. Mayjen. H.M. Ryacudu No.12 Kel. 7
                                        Ulu Kec. Seberang Ulu I</a></p>

                                <br>
                                <h5><b>Unit Pelayanan Kalidoni</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/e7Kah4NEXo3eYGqx6">Jl. Residen Abdul Rozak No.01 Kel.
                                        Kalidoni Kec. Kalidoni</a></p>

                                <br>
                                <h5><b>Unit Pelayanan Karang Anyar</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/NZ7SCJBnQiN3emcN8">Jl. Alamsyah Ratu Prawiranegara No.
                                        591A Kel. Karang Jaya Kec. Gandus</a></p>

                                <br>
                                <h5><b>Unit Pelayanan Alang-Alang Lebar</b></h5>
                                <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i><a
                                        href="https://goo.gl/maps/sp3NYro1EagJqyCS9">Jl. Soekarno Hatta Kel. Karya Baru
                                        Kec. Alang-Alang Lebar</a></p>
